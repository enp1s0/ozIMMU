...
inline mtk::mateval::layout_t conv_layout_oz2mateval(const mtk::ozimmu::operation_t op) {
...
std::vector<mtk::ozimmu::compute_mode_t> get_compute_mode_list_from_argv(
