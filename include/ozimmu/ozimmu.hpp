...
void set_cuda_stream(mtk::ozimmu::handle_t handle, const cudaStream_t cuda_stream);

void enable_profiling(mtk::ozimmu::handle_t handle);
void disable_profiling(mtk::ozimmu::handle_t handle);
void print_profiler_result(mtk::ozimmu::handle_t handle, const std::string tag, const bool csv = false);
...
mtk::ozimmu::data_t get_output_type(
		const mtk::ozimmu::compute_mode_t mode
		);
